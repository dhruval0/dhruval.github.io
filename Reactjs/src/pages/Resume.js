        ...
        <ol className="timeline-list">
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              ...
              thinking, decision-making, and problem-solving abilities. It also
              teaches me how to be responsible citizens and social contributors.
              It is the acquisition of information, values, skills, and habits.
            </p>
          </li>
        ...
        <ol className="timeline-list">
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              ...
              Unity is used to provide the scripting and interactive nature. The
              project's purpose was to provide people an overview of the BITS
              (Babaria Institute of Technology) building without them having to
              go there. The parents and students who wanted to take a tour of
              the Collage were the primary target audience for this initiative.
            </p>
          ...
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              ...
              pages, size, and so on. Using Stanza, Huggingface-hub, and Spacy,
              I implemented keyword extractions, text summarization,
          ...
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              ...
              and requests all have their own database, which has been built and
              upgraded. The chat module uses web sockets, the request module
              uses firebase notifications, and the email module uses an SMTP
              server. Dockerization was also applied to the backend application.
            </p>
            <h5 className="h5 project-technologies">
              Technologies: FastAPI, MongoDB, Socket-Io, Firebase, smtp-server,
              Docker, S3-Amazon, Git
            </h5>
          </li>
          ...
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              ...
              created. Furthermore, utilising the Microsoft Azure architecture,
              convert text to voice and speech to text into APIs and deploy on
              the server, and utilise blob services to store data init. In
              addition, using the Azure model, I generated a subtitle file in
              the format of srt.
            </p>
            <h5 className="h5 project-technologies">
          ...
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              Its architecture is based on MongoDB(NoSQL Database) and FastAPI.
              I used selenium, scrapy, and beautifulSoup to collect news data
              from a number of news sources and put it in a database. To execute
              Text-generation operations like Text-summarization, use the flask
              API, which is hosted on Google colab with the help of ngrok. On
              the Contabo server, this application was likewise deployed using
              Node.
            </p>
            <h5 className="h5 project-technologies">
              Technologies: FastAPI, MongoDB, Selenium, Scrapy, Huggingface-Hub,
              Flask, Contabo server, Google Colab, Git
            </h5>
          </li>
          ...
          <li className="timeline-item">
            ...
            <p className="timeline-text">
              To integrate user-card transaction APIs, I worked on a DRF (Django
              Rest Framework) application. It was implemented using the marqeta
              Platform. Also utilised docker images such as celery for task
              automation, reddis for in-memory data structure storage, used as a
              database, cache, and PostgreSQL database, and adminer to see data.
              CJ-platform was also scraped for affiliate marketing.
            </p>
            <h5 className="h5 project-technologies">
